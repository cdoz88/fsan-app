        ...
        <div className="flex-1 w-full min-w-0 pt-6 relative">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4 py-2 mb-8 bg-[#151515] p-2 rounded-2xl border border-gray-800/50 w-fit mx-auto shadow-inner animate-in fade-in duration-500 delay-100">
             <button 
                ...
                className={`px-5 py-3 rounded-xl font-black uppercase tracking-widest text-xs transition-all flex items-center gap-2 ${activeTab === 'leaderboard' ? 'bg-blue-600 text-white shadow-[0_0_20px_rgba(37,99,235,0.4)]' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-800/50'}`}
             >
               <ListOrdered size={16} /> Leaderboard
             </button>
             <button 
                onClick={() => setActiveTab('cause')} 
                className={`px-5 py-3 rounded-xl font-black uppercase tracking-widest text-xs transition-all flex items-center gap-2 ${activeTab === 'cause' ? 'bg-orange-600 text-white shadow-[0_0_20px_rgba(234,88,12,0.4)]' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-800/50'}`}
             >
               <Heart size={16} /> The Cause
             </button>
             <button 
                onClick={() => setActiveTab('rules')} 
                className={`px-5 py-3 rounded-xl font-black uppercase tracking-widest text-xs transition-all flex items-center gap-2 ${activeTab === 'rules' ? 'bg-red-600 text-white shadow-[0_0_20px_rgba(220,38,38,0.4)]' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-800/50'}`}
             >
          ...
          {/* TAB 2: THE CAUSE (Story & Join Funnel) */}
          {activeTab === 'cause' && (
                ...
                <div className="lg:col-span-7 flex flex-col gap-8">
                  ...
                  <section className="bg-[#1a1a1a] rounded-3xl p-8 md:p-10 border border-gray-800 shadow-xl">
                     ...
                     <div className="flex flex-col gap-6">
                        <div className="bg-gradient-to-br from-[#151515] to-[#111] p-6 rounded-2xl border border-gray-800 shadow-inner flex items-start gap-4">
                ...
                <section className="bg-[#1a1a1a] rounded-3xl p-8 md:p-10 border border-gray-800 shadow-xl">
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                      ...
                      <div className="bg-[#111] rounded-2xl p-6 border border-gray-800 shadow-inner">
                         ...
                         <ul className="space-y-4 text-sm text-gray-400 font-medium">
                           <li className="flex gap-3 items-start"><span className="text-orange-500 font-black text-lg leading-none">»</span> <span className="pt-0.5">PPR PPFD "Big Plays"</span></li>
                           <li className="flex gap-3 items-start"><span className="text-orange-500 font-black text-lg leading-none">»</span> <span className="pt-0.5">Start: 1QB 2RB 3WR 1TE 1FLEX 1DST</span></li>
                           <li className="flex gap-3 items-start"><span className="text-orange-500 font-black text-lg leading-none">»</span> <span className="pt-0.5">Bench: 5 Players (Plus 1 IR)</span></li>
                           <li className="flex gap-3 items-start"><span className="text-orange-500 font-black text-lg leading-none">»</span> <span className="pt-0.5">Playoffs: Top 4 advance in Wk 15</span></li>
                           <li className="flex gap-3 items-start"><span className="text-orange-500 font-black text-lg leading-none">»</span> <span className="pt-0.5">Two-Week Championship (Wks 16 & 17)</span></li>
                           <li className="flex gap-3 items-start"><span className="text-orange-500 font-black text-lg leading-none">»</span> <span className="pt-0.5">Winner: Most points among league champs</span></li>
                         </ul>
                      </div>
                   </div>
                </section>
