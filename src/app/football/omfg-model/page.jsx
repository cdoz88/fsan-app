...
import OmfgClient from './OmfgClient';
import { getMenuBySlug } from '../../../utils/api';

export const metadata = {
  title: 'OMFG Utilization Model | FSAN',
  description: 'Advanced fantasy football utilization scores and underlying usage metrics.',
};

export default async function OmfgPage() {
  let proToolsMenu = [];
  let connectMenu = [];
