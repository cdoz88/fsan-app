...
export const metadata = {
  title: 'OMFG Rest of Season Model | FSAN',
  description: 'Forecast expected output and percentile distributions (Floor, Base, Ceiling) over the remaining NFL schedule.',
};
