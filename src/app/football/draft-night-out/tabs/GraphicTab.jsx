  ...
  useEffect(() => {
    const updateScale = () => {
      if (wrapperRef.current) {
        ...
        // 1080 is the fixed width of our graphic
    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 mb-16">
      ...
      {starters.length > 0 && teamData && (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          {/* 🚀 RESPONSIVE WRAPPER: Fits within screen width, but maintains 1080x1350 aspect ratio */}
          <div ref={wrapperRef} className="w-full flex justify-center overflow-hidden bg-[#0a0a0a] rounded-3xl border border-zinc-800 shadow-2xl mb-6">
              
              {/* Dynamic container that physically shrinks to fit the page */}
              <div style={{ width: '1080px', height: `${1350 * scale}px`, overflow: 'hidden' }}>
                  
                  {/* The scaled graphic. html2canvas will read this perfectly. */}
                  <div style={{ transform: `scale(${scale})`, transformOrigin: 'top left' }}>
                    
                    <div ref={graphicRef} className="w-[1080px] h-[1350px] bg-zinc-950 border border-zinc-800 overflow-hidden flex flex-col shrink-0 relative">
                      
                      <img src={dnoBgUrl} className="absolute inset-0 w-full h-full object-cover opacity-30 mix-blend-luminosity z-0" crossOrigin="anonymous" alt="Background" />
                      ...
                      <div className="relative z-10 p-8 flex items-center justify-between border-b border-zinc-800/50 bg-black/60 backdrop-blur-md h-[140px] shrink-0">
                        <div className="flex items-center gap-6">
                           <img src={dnoLogoUrl} alt="DNO" className="h-16 w-auto object-contain drop-shadow-lg" crossOrigin="anonymous" />
                           <div>
                              ...
                              {starters.map((playerId, idx) => {
                                ...
                                return (
                                  <div key={`starter-${playerId}-${idx}`} className="relative w-full h-[230px] flex flex-col justify-end group shadow-xl">
                                    ...
                                    {/* 🚀 Container A: The Background Card (Overflow Hidden) */}
                                    ...
                                    {/* 🚀 Container B: Player Image (OUTSIDE overflow hidden, anchored to bottom, scaled via h-[125%]) */}
                                    ...
                                    {/* 🚀 THE MISSING GRADIENT FADE 🚀 (Overlays the player's torso, anchored to bottom) */}
                                    ...
                                    {/* Typography Footer */}
                                    <div className="relative z-30 px-3 pb-4 pt-2 mt-auto flex flex-col items-center text-center bg-transparent pointer-events-none">
                                ...
                                {bench.map((playerId, idx) => {
                                  ...
                                  return (
                                    <div key={`bench-${playerId}-${idx}`} className={`relative w-full h-[64px] rounded-[16px] flex items-center overflow-hidden bg-zinc-950 border border-zinc-800 shadow-md`}>
                                       ...
                                       {/* 🚀 Position Text (No solid background) */}
                                       ...
                                       {/* 🚀 Circular Headshot */}
                                       <div className="w-11 h-11 mx-1 rounded-full bg-zinc-900 border border-zinc-700/50 flex items-center justify-center overflow-hidden shrink-0 relative z-20 shadow-md">
                                          <img 
                                            src={playerImage} 
                                            alt="" 
                                       ...
                                       {/* 🚀 Player Name (No secondary team logo) */}
