...
// Chart.js Imports for the Stats Modal
...
function DashboardContent() {
  ...
  // Triggered when clicking "View Detailed Stats" on a league card
                  ...
                  return (
                    <div key={league.id} className="bg-[#111] border border-gray-800 rounded-2xl p-6 flex flex-col justify-between hover:border-gray-700 transition-colors">
                      <div>
                        ...
                        {/* Injected Leaderboard Stats Banner (Only shows if the season has started & stats exist) */}
                        {teamStats && (
                      ...
                      <div className="flex gap-2 w-full mt-auto">
                        ...
                        {/* Reveal the detailed stats modal button if stats exist */}
                        {teamStats && (
                          <button 
