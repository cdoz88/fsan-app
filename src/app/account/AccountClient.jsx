                ...
                <>
                        ...
                        <div className="flex flex-col gap-2">
                          <div className="relative">
                            <input 
                              ...
                              className="w-full bg-[#111] border border-gray-700 text-white rounded-xl px-4 py-3 pl-12 text-sm focus:outline-none focus:border-blue-500 transition-colors shadow-inner"
                            />
                  ...
                  <div className="bg-[#1a1a1a] border border-gray-800 rounded-xl p-5 md:p-6 mt-6">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-400">
                            {yahooLeaguesCount > 0 ? `${yahooLeaguesCount} leagues synced` : 'Not connected'}
                          </p>
                        </div>
                      </div>
                    ...
                    {userTier === 'pro' || userTier === 'pro-plus' ? (
                      <div className="flex flex-col gap-4">
                        <a 
                           href="/api/yahoo/auth/url" 
                           className="bg-[#410099] hover:bg-[#32007a] text-white font-bold text-sm px-6 py-3 rounded-xl transition-all shadow-sm flex items-center gap-2 max-w-[250px] justify-center"
                        >
