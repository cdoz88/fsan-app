...
function AccountDashboardContent() {
  ...
  // Add state to track copy status
  ...
  // Helper function to copy the discount code
          ...
          <div className="space-y-6 animate-in fade-in duration-500 relative z-10">
            ...
            {userTier === 'free' ? (
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gradient-to-br from-[#1a1a1a] to-[#111] border border-gray-800 rounded-2xl p-6 relative overflow-hidden group hover:border-gray-600 transition-all shadow-lg flex flex-col">
                      <div className="absolute -right-4 -top-4 text-white/20 z-0 pointer-events-none group-hover:scale-110 transition-transform duration-500">
