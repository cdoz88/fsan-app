...
// Custom SVG Component for the Premium Community Icon
const PremiumCommunityIcon = ({ className = "", size = 24 }) => (
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  {userTier === 'pro-plus' ? (
                      ...
                      <div className="bg-gradient-to-br from-[#1a1a1a] to-[#111] border border-gray-800 rounded-2xl p-6 relative overflow-hidden flex flex-col">
                          ...
                          <div className="relative z-10 flex flex-col h-full">
                              <h3 className="text-lg font-black text-gray-300 uppercase tracking-wide mb-2">Football Rookie Draft Guide</h3>
                  ...
                  {/* Merch Shop Discount - PRO & PRO+ (Standard Grey formatting now) */}
                  ...
                  <div className="bg-gradient-to-br from-[#1a1a1a] to-[#111] border border-gray-800 rounded-2xl p-6 relative overflow-hidden group hover:border-gray-600 transition-all shadow-lg flex flex-col">
                      <div className="absolute -right-4 -top-4 text-gray-800/20 z-0 pointer-events-none group-hover:scale-110 transition-transform duration-500">
                          <PremiumCommunityIcon size={120} />
                      </div>
                      <div className="relative z-10 flex flex-col h-full">
                          
                          {/* UPDATED: Icon and Title side by side using custom SVG */}
                          <div className="flex items-center gap-3 mb-4">
                             <div className="w-12 h-12 bg-blue-900/20 text-blue-500 border border-blue-500/30 rounded-xl flex items-center justify-center shadow-inner shrink-0">
                                 <PremiumCommunityIcon size={24} />
                             </div>
